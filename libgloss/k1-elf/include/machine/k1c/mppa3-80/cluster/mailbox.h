...
#ifndef _INCLUDED_CLUSTER_MAILBOX_H_
#define _INCLUDED_CLUSTER_MAILBOX_H_

#ifndef __ASSEMBLER__

#include "machine/devices/mailbox.coolidge.dev"

enum {
MPPA_SECURE_APIC_MAILBOX__ADDR = 0xD40000,
...
__attribute__((unused)) static volatile mppa_mailbox_t *mppa_secure_apic_mailbox = (mppa_mailbox_t *)(MPPA_SECURE_APIC_MAILBOX__ADDR);
__attribute__((unused)) static volatile mppa_mailbox_t *mppa_mailbox_local = (mppa_mailbox_t *)(MPPA_MAILBOX_LOCAL__ADDR);


#endif /* __ASSEMBLER__ */

#endif // _INCLUDED_CLUSTER_MAILBOX_H_
