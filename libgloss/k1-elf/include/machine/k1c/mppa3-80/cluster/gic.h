...
#ifndef _INCLUDED_CLUSTER_GIC_H_
#define _INCLUDED_CLUSTER_GIC_H_

#ifndef __ASSEMBLER__

#include "machine/devices/gic.coolidge.dev"
...
__attribute__((unused)) static volatile mppa_gic_t *mppa_secure_apic_gic = (mppa_gic_t *)(MPPA_SECURE_APIC_GIC__ADDR);
__attribute__((unused)) static volatile mppa_gic_t *mppa_gic_local = (mppa_gic_t *)(MPPA_GIC_LOCAL__ADDR);


#endif /* __ASSEMBLER__ */

#endif // _INCLUDED_CLUSTER_GIC_H_
