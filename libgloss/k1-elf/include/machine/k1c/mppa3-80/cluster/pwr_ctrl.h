...
#ifndef _INCLUDED_CLUSTER_PWR_CTRL_H_
#define _INCLUDED_CLUSTER_PWR_CTRL_H_

#ifndef __ASSEMBLER__

#include "machine/devices/pwr_ctrl.coolidge.dev"
...
__attribute__((unused)) static volatile mppa_pwr_ctrl_t *mppa_pwr_ctrl_local = (mppa_pwr_ctrl_t *)(MPPA_PWR_CTRL_LOCAL__ADDR);


#endif /* __ASSEMBLER__ */

#endif // _INCLUDED_CLUSTER_PWR_CTRL_H_
